...
export class ModuleComponent {
  ...
  NewRecord() {
    ...
    this.Record.module_parent_id = '';
    this.Record.module_parent_name = '';
  ...
  LovSelected(_Record: SearchTable) {
    if (_Record.controlname == "MODULE") {
      this.Record.module_parent_id = _Record.id;
      this.Record.module_parent_name = _Record.name;
    }
  }
