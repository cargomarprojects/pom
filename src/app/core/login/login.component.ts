...
export class LoginComponent {
  ...
  errorMessageVersion: string = '1.349';
  software_version_string: string = '1.349';
    ...
    this.loginservice.Login(this.username, this.password, this.company_code)
      .subscribe(response => {
        ...
        if (user && user.access_token) {
          ...
          this.gs.globalVariables.appid = user.usertokenid;
  ...
  LoadMenu() {
    let SearchData = {
      ...
      tokenid: this.gs.globalVariables.appid
    };
    ...
    this.loginservice.LoadMenu(SearchData)
      .subscribe(response => {
        ...
        localStorage.setItem('appid', this.gs.globalVariables.appid);
